...
Процедура ДобавитьСправку2ВТабличнуюЧасть(ДанныеСправки2)
	...
	ЗаполнитьЗначенияСвойств(СтрокаТЧ, ДанныеСправки2,, "Справка2");
...
Процедура ОбновитьСтатусЕГАИС()
	...
	РедактированиеФормыНеДоступно = СтатусЕГАИС <> Перечисления.СтатусыОбработкиАктаПостановкиНаБалансЕГАИС.Черновик
