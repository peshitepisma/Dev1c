...
Процедура ЗаполнитьВидыЗапасовДокумента(Отказ)
	...
	Иначе // хоз. операция - Сторно списания на расходы.
		...
		ВидыЗапасов.Свернуть("АналитикаУчетаНоменклатуры, ВидЗапасов, НомерГТД, ВидЗапасовОтгрузки, СкладОтгрузки, ДокументРеализации, СтатьяРасходов, АналитикаРасходов", "Количество");
