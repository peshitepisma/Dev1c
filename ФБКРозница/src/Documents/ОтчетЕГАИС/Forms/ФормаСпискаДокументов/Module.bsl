...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если ТекущиеДанные.СтатусЕГАИС = ПредопределенноеЗначение("Перечисление.СтатусыОбработкиОтчетаЕГАИС.ПолученОтчет") Тогда
		...
		ИначеЕсли ТекущиеДанные.ВидДокумента = ПредопределенноеЗначение("Перечисление.ВидыДокументовЕГАИС.ЗапросОтчетаОстаткиВРегистре1")
			ИЛИ ТекущиеДанные.ВидДокумента = ПредопределенноеЗначение("Перечисление.ВидыДокументовЕГАИС.ЗапросОтчетаОстаткиВРегистре2") Тогда
...
Процедура ОтметитьОтработкуРасхожденийНаСервере(ДокументСсылка, ВидДокумента)
	...
	НовыйСтатус = Документы.ОтчетЕГАИС.ОбновитьСтатусПослеПолученияДанных(
		...
		ИнтеграцияЕГАИС.ПараметрыОбновленияСтатуса(Ложь));
