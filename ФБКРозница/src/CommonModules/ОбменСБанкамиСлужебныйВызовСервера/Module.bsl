...
Функция РеквизитыЭлектронногоДокумента(ДокументСсылка) Экспорт
	...
	Если Результат.Следующий() Тогда
		СтруктураВозврата = Новый Структура("Состояние, СообщениеОбмена");
...
Процедура ПолучитьЗначенияРеквизитовСообщенияОбмена(Знач СообщениеОбмена, ЗапрашиваемыеРеквизиты) Экспорт
	...
	РеквизитыСообщенияОбмена = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(
		СообщениеОбмена, "Представление, Идентификатор, ВнешнийИдентификатор");
...
Функция СообщениеСодержитПодписьПоСертификату(СообщениеОбмена, СертификатСсылка) Экспорт
	...
	Если МассивОтпечатков.Найти(ОтпечатокСертификата) <> Неопределено Тогда
		...
		Представление = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(СообщениеОбмена, "Представление");
		ТекстСообщения = СтрШаблон(ТекстСообщения, Представление, СертификатСсылка);
...
Функция НайтиВыпискуСбербанк(НастройкаОбмена, ВнешнийИдентификатор)
	...
	|	И СообщениеОбменСБанками.ПометкаУдаления";
	Запрос.УстановитьПараметр("НастройкаОбмена", НастройкаОбмена);
