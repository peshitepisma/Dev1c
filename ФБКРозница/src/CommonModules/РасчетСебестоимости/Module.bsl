...
Процедура СформироватьУзлыКорректировкиСписанияСтоимости(ПараметрыРасчета)
	...
	|				ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.Стоимость) КАК ЧИСЛО(31,10)) / СУММА(ВложенныйЗапрос.Количество)
	|			ИНАЧЕ 0
	|		КОНЕЦ КАК ЧИСЛО(31,10))  			   КАК Стоимость,
	|	ВЫРАЗИТЬ(
	|		ВЫБОР
	|			КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|				ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.СтоимостьБезНДС) КАК ЧИСЛО(31,10)) / СУММА(ВложенныйЗапрос.Количество)
	|			ИНАЧЕ 0
	...
	|		ВЫБОР
	|			КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|				ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ДопРасходы) КАК ЧИСЛО(31,10)) / СУММА(ВложенныйЗапрос.Количество)
	|			ИНАЧЕ 0
	|		КОНЕЦ КАК ЧИСЛО(31,10))  			   КАК СтоимостьДопРасходы,
	|	ВЫРАЗИТЬ(
	|		ВЫБОР
	|			КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|				ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ДопРасходыБезНДС) КАК ЧИСЛО(31,10)) / СУММА(ВложенныйЗапрос.Количество)
	|			ИНАЧЕ 0
	|		КОНЕЦ КАК ЧИСЛО(31,10))  			   КАК СтоимостьДопРасходыБезНДС,
	|
	|	ВЫРАЗИТЬ(
	|		ВЫБОР
	|			КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|				ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.СтоимостьЗабалансовая) КАК ЧИСЛО(31,10)) / СУММА(ВложенныйЗапрос.Количество)
	|			ИНАЧЕ 0
	|		КОНЕЦ КАК ЧИСЛО(31,10))  			   КАК СтоимостьЗабалансовая,
	|	ВЫРАЗИТЬ(
	|		ВЫБОР
	|			КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|				ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.Трудозатраты) КАК ЧИСЛО(31,10)) / СУММА(ВложенныйЗапрос.Количество)
	|			ИНАЧЕ 0
	|		КОНЕЦ КАК ЧИСЛО(31,10))  			   КАК Трудозатраты,
	|	ВЫРАЗИТЬ(
	|		ВЫБОР
	|			КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|				ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ПостатейныеПостоянныеСНДС) КАК ЧИСЛО(31,10)) / СУММА(ВложенныйЗапрос.Количество)
	|			ИНАЧЕ 0
	|		КОНЕЦ КАК ЧИСЛО(31,10))  			   КАК ПостатейныеПостоянныеСНДС,
	|	ВЫРАЗИТЬ(
	|		ВЫБОР
	|			КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|				ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ПостатейныеПостоянныеБезНДС) КАК ЧИСЛО(31,10)) / СУММА(ВложенныйЗапрос.Количество)
	|			ИНАЧЕ 0
	|		КОНЕЦ КАК ЧИСЛО(31,10))  			   КАК ПостатейныеПостоянныеБезНДС,
	|
	|	ВЫРАЗИТЬ(
	|		ВЫБОР
	|			КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|				ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ПостатейныеПеременныеСНДС) КАК ЧИСЛО(31,10)) / СУММА(ВложенныйЗапрос.Количество)
	|			ИНАЧЕ 0
	|		КОНЕЦ КАК ЧИСЛО(31,10))  			   КАК ПостатейныеПеременныеСНДС,
	|	ВЫРАЗИТЬ(
	|		ВЫБОР
	|			КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|				ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ПостатейныеПеременныеБезНДС) КАК ЧИСЛО(31,10)) / СУММА(ВложенныйЗапрос.Количество)
	|			ИНАЧЕ 0
	|		КОНЕЦ КАК ЧИСЛО(31,10))  			   КАК ПостатейныеПеременныеБезНДС,
	...
	|				ИЛИ УчетСебестоимости.ТипЗаписи = ЗНАЧЕНИЕ(Перечисление.ТипыЗаписейПартий.Дополнение)) ТОГДА
...
Процедура ЗарегистрироватьСтоимость(ПараметрыРасчета, РегистрацияСтоимостиРегл)
	...
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.Стоимость КАК ЧИСЛО(31,10)) / Остатки.Количество 			 	 		КАК ЧИСЛО(31,10)) КАК Стоимость,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.СтоимостьБезНДС КАК ЧИСЛО(31,10)) / Остатки.Количество 		 		КАК ЧИСЛО(31,10)) КАК СтоимостьБезНДС,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ДопРасходы КАК ЧИСЛО(31,10)) / Остатки.Количество 		 	 		КАК ЧИСЛО(31,10)) КАК СтоимостьДопРасходы,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ДопРасходыБезНДС КАК ЧИСЛО(31,10)) / Остатки.Количество  		 		КАК ЧИСЛО(31,10)) КАК СтоимостьДопРасходыБезНДС,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ПостояннаяРазница КАК ЧИСЛО(31,10)) / Остатки.Количество 	 	 		КАК ЧИСЛО(31,10)) КАК ПостояннаяРазница,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ВременнаяРазница КАК ЧИСЛО(31,10)) / Остатки.Количество 		 		КАК ЧИСЛО(31,10)) КАК ВременнаяРазница,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.СтоимостьЗабалансовая КАК ЧИСЛО(31,10)) / Остатки.Количество   		КАК ЧИСЛО(31,10)) КАК СтоимостьЗабалансовая,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.Трудозатраты КАК ЧИСЛО(31,10)) / Остатки.Количество 			 		КАК ЧИСЛО(31,10)) КАК Трудозатраты,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ПостатейныеПостоянныеСНДС КАК ЧИСЛО(31,10)) / Остатки.Количество 		 КАК ЧИСЛО(31,10)) КАК ПостатейныеПостоянныеСНДС,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ПостатейныеПостоянныеБезНДС КАК ЧИСЛО(31,10)) / Остатки.Количество	 КАК ЧИСЛО(31,10)) КАК ПостатейныеПостоянныеБезНДС,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ПостатейныеПеременныеСНДС КАК ЧИСЛО(31,10)) / Остатки.Количество 		 КАК ЧИСЛО(31,10)) КАК ПостатейныеПеременныеСНДС,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ПостатейныеПеременныеБезНДС КАК ЧИСЛО(31,10)) / Остатки.Количество	 КАК ЧИСЛО(31,10)) КАК ПостатейныеПеременныеБезНДС,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.СтоимостьУпр КАК ЧИСЛО(31,10)) / Остатки.Количество 		 			 КАК ЧИСЛО(31,10)) КАК СтоимостьУпр,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ДопРасходыУпр КАК ЧИСЛО(31,10)) / Остатки.Количество 		 			 КАК ЧИСЛО(31,10)) КАК ДопРасходыУпр,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ТрудозатратыУпр КАК ЧИСЛО(31,10)) / Остатки.Количество 		 		 КАК ЧИСЛО(31,10)) КАК ТрудозатратыУпр,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ПостатейныеПостоянныеУпр КАК ЧИСЛО(31,10)) / Остатки.Количество 		 КАК ЧИСЛО(31,10)) КАК ПостатейныеПостоянныеУпр,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ПостатейныеПеременныеУпр КАК ЧИСЛО(31,10)) / Остатки.Количество 		 КАК ЧИСЛО(31,10)) КАК ПостатейныеПеременныеУпр,
	|	ВЫБОР
...
Процедура СформироватьУзлыКорректировкиСписанияСтоимостиРегл(ПараметрыРасчета)
	...
	|	ВЫРАЗИТЬ(
	|		ВЫБОР КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|			ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.СтоимостьУпр) КАК ЧИСЛО(31,10)) / СУММА(ВложенныйЗапрос.Количество)
	|		ИНАЧЕ
	|			0
	...
	|				-ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ПостояннаяРазница) КАК ЧИСЛО(31,10)) / СУММА(ВложенныйЗапрос.Количество)
	|			КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|				ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ПостояннаяРазница) КАК ЧИСЛО(31,10)) / СУММА(ВложенныйЗапрос.Количество)
	|			ИНАЧЕ 0
	...
	|				-ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ВременнаяРазница) КАК ЧИСЛО(31,10)) / СУММА(ВложенныйЗапрос.Количество)
	|			КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|				ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ВременнаяРазница) КАК ЧИСЛО(31,10)) / СУММА(ВложенныйЗапрос.Количество)
	|			ИНАЧЕ 0
	...
	|	ВЫРАЗИТЬ(
	|		ВЫБОР КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|			ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.СтоимостьДопРасходы) КАК ЧИСЛО(31,10)) / СУММА(ВложенныйЗапрос.Количество)
	|		ИНАЧЕ
	|			0
	|		КОНЕЦ КАК ЧИСЛО(31,10))   КАК СтоимостьДопРасходы,
	...
	|	ВЫРАЗИТЬ(
	|		ВЫБОР КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|			ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ДопРасходыУпр) КАК ЧИСЛО(31,10)) / СУММА(ВложенныйЗапрос.Количество)
	|		ИНАЧЕ
	|			0
	|		КОНЕЦ КАК ЧИСЛО(31,10))   КАК ДопРасходыУпр,
	|	ВЫРАЗИТЬ(
	|		ВЫБОР КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|			ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.СтоимостьЗабалансовая) КАК ЧИСЛО(31,10)) / СУММА(ВложенныйЗапрос.Количество)
	|		ИНАЧЕ
	...
	|	ВЫРАЗИТЬ(
	|		ВЫБОР КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|			ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ТрудозатратыУпр) КАК ЧИСЛО(31,10)) / СУММА(ВложенныйЗапрос.Количество)
	|		ИНАЧЕ
	|			0
	|		КОНЕЦ КАК ЧИСЛО(31,10))   КАК ТрудозатратыУпр,
	|	ВЫРАЗИТЬ(
	|		ВЫБОР КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|			ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ПостатейныеПостоянныеУпр) КАК ЧИСЛО(31,10)) / СУММА(ВложенныйЗапрос.Количество)
	|		ИНАЧЕ
	|			0
	|		КОНЕЦ КАК ЧИСЛО(31,10))   КАК ПостатейныеПостоянныеУпр,
	|	ВЫРАЗИТЬ(
	|		ВЫБОР КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|			ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ПостатейныеПеременныеУпр) КАК ЧИСЛО(31,10)) / СУММА(ВложенныйЗапрос.Количество)
	|		ИНАЧЕ
	|			0
	|		КОНЕЦ КАК ЧИСЛО(31,10))   КАК ПостатейныеПеременныеУпр
	|
	|ПОМЕСТИТЬ ВтУзлыКорректировки
	|ИЗ
	|
...
Процедура СкорректироватьСтоимостьСписанияЗапасов(ПараметрыРасчета)
	...
	|			И (ВЫРАЗИТЬ(ТаблицаКорректировки.Количество * ЕСТЬNULL(СтоимостьТоваров.Стоимость, 0) КАК ЧИСЛО(15,2))
	|				+ ВЫРАЗИТЬ(ТаблицаКорректировки.Количество * ЕСТЬNULL(СтоимостьТоваров.СтоимостьДопРасходы, 0) КАК ЧИСЛО(15,2))
	|				- ТаблицаКорректировки.Стоимость) < 0
	|			ТОГДА НЕОПРЕДЕЛЕНО
	...
	Пока Выборка.Следующий() Цикл
		...
		Если (Выборка.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВозвратТоваровПоставщику
			...
			Если СуммаСНДС > 0 Или СуммаБезНДС > 0 Или СуммаРегл > 0 Или СуммаУпр > 0
...
Процедура РаспределитьВыручкуПоНаправлениямДеятельности(ПараметрыРасчета)
	...
	|		+ ВыручкаИСебестоимость.ДопРасходы) КАК Себестоимость
...
Функция ТекстЗапросаДвиженияСтоимости(ПараметрыРасчета)
	...
	|	ВЫРАЗИТЬ(УзлыКорректировки.Стоимость КАК ЧИСЛО(31,10))                  	КАК Стоимость,
	|	ВЫРАЗИТЬ(УзлыКорректировки.СтоимостьБезНДС КАК ЧИСЛО(31,10))            	КАК СтоимостьБезНДС,
	|	ВЫРАЗИТЬ(УзлыКорректировки.ПостояннаяРазница КАК ЧИСЛО(31,10))          	КАК ПостояннаяРазница,
	|	ВЫРАЗИТЬ(УзлыКорректировки.ВременнаяРазница КАК ЧИСЛО(31,10))           	КАК ВременнаяРазница,
	|	ВЫРАЗИТЬ(УзлыКорректировки.СтоимостьДопРасходы КАК ЧИСЛО(31,10))        	КАК СтоимостьДопРасходы,
	|	ВЫРАЗИТЬ(УзлыКорректировки.СтоимостьДопРасходыБезНДС КАК ЧИСЛО(31,10))  	КАК СтоимостьДопРасходыБезНДС,
	|	ВЫРАЗИТЬ(УзлыКорректировки.СтоимостьЗабалансовая КАК ЧИСЛО(31,10))      	КАК СтоимостьЗабалансовая,
	|	ВЫРАЗИТЬ(УзлыКорректировки.Трудозатраты КАК ЧИСЛО(31,10))  					КАК Трудозатраты,
	|	ВЫРАЗИТЬ(УзлыКорректировки.ПостатейныеПостоянныеСНДС КАК ЧИСЛО(31,10))  	КАК ПостатейныеПостоянныеСНДС,
	|	ВЫРАЗИТЬ(УзлыКорректировки.ПостатейныеПостоянныеБезНДС КАК ЧИСЛО(31,10))  	КАК ПостатейныеПостоянныеБезНДС,
	|	ВЫРАЗИТЬ(УзлыКорректировки.ПостатейныеПеременныеСНДС КАК ЧИСЛО(31,10))     	КАК ПостатейныеПеременныеСНДС,
	|	ВЫРАЗИТЬ(УзлыКорректировки.ПостатейныеПеременныеБезНДС КАК ЧИСЛО(31,10))   	КАК ПостатейныеПеременныеБезНДС,
	|	ВЫРАЗИТЬ(УзлыКорректировки.СтоимостьУпр КАК ЧИСЛО(31,10))   				КАК СтоимостьУпр,
	|	ВЫРАЗИТЬ(УзлыКорректировки.ДопРасходыУпр КАК ЧИСЛО(31,10))   				КАК ДопРасходыУпр,
	|	ВЫРАЗИТЬ(УзлыКорректировки.ТрудозатратыУпр КАК ЧИСЛО(31,10))   				КАК ТрудозатратыУпр,
	|	ВЫРАЗИТЬ(УзлыКорректировки.ПостатейныеПостоянныеУпр КАК ЧИСЛО(31,10))   	КАК ПостатейныеПостоянныеУпр,
	|	ВЫРАЗИТЬ(УзлыКорректировки.ПостатейныеПеременныеУпр КАК ЧИСЛО(31,10))   	КАК ПостатейныеПеременныеУпр
...
Функция УстановитьРазрядностьЧиселВТекстеЗапроса(ПараметрыРасчета, ТекстЗапроса)
	...
	Если ПараметрыРасчета.РешениеСЛУ.РазрядностьДляРасчетов <> 31 Тогда
...
Процедура СформироватьДвиженияНоменклатураДоходыРасходы(ПараметрыРасчета, ДанныеДвижения, ДанныеСумм,
	...
	Иначе
		...
		КонецЕсли;
		Если ДанныеДвижения.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПередачаВСоставОС
			ИЛИ ДанныеДвижения.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПередачаВСоставНМА Тогда
			Запись.НаправлениеДеятельностиСтатьи = ДанныеДвижения.КорНаправлениеДеятельности;
		КонецЕсли;
	КонецЕсли;
...
Процедура РешитьСЛУ(ПараметрыРасчета, РасчетСтоимостиРегл)
	...
	|ВЫБРАТЬ
	|	УзлыКорректировки.НомерУзла                                      КАК НомерУзла,
	|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.Стоимость)                   КАК ЧИСЛО(31,10)) КАК СвободныйКоэффициент,
	|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.СтоимостьБезНДС)             КАК ЧИСЛО(31,10)) КАК СвободныйКоэффициентБезНДС,
	|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.ПостояннаяРазница)           КАК ЧИСЛО(31,10)) КАК СвободныйКоэффициентПостояннаяРазница,
	|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.ВременнаяРазница)            КАК ЧИСЛО(31,10)) КАК СвободныйКоэффициентВременнаяРазница,
	|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.СтоимостьДопРасходы)         КАК ЧИСЛО(31,10)) КАК СвободныйКоэффициентДопРасходы,
	|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.СтоимостьДопРасходыБезНДС)   КАК ЧИСЛО(31,10)) КАК СвободныйКоэффициентДопРасходыБезНДС,
	|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.СтоимостьЗабалансовая)       КАК ЧИСЛО(31,10)) КАК СвободныйКоэффициентСтоимостьЗабалансовая,
	|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.Трудозатраты)  				 КАК ЧИСЛО(31,10)) КАК СвободныйКоэффициентТрудозатраты,
	|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.ПостатейныеПостоянныеСНДС)   КАК ЧИСЛО(31,10)) КАК СвободныйКоэффициентПостатейныеПостоянныеСНДС,
	|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.ПостатейныеПостоянныеБезНДС) КАК ЧИСЛО(31,10)) КАК СвободныйКоэффициентПостатейныеПостоянныеБезНДС,
	|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.ПостатейныеПеременныеСНДС)   КАК ЧИСЛО(31,10)) КАК СвободныйКоэффициентПостатейныеПеременныеСНДС,
	|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.ПостатейныеПеременныеБезНДС) КАК ЧИСЛО(31,10)) КАК СвободныйКоэффициентПостатейныеПеременныеБезНДС,
	|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.СтоимостьУпр) 				 КАК ЧИСЛО(31,10)) КАК СвободныйКоэффициентУпр,
	|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.ДопРасходыУпр) 	 			 КАК ЧИСЛО(31,10)) КАК СвободныйКоэффициентДопРасходыУпр,
	|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.ТрудозатратыУпр) 			 КАК ЧИСЛО(31,10)) КАК СвободныйКоэффициентТрудозатратыУпр,
	|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.ПостатейныеПостоянныеУпр) 	 КАК ЧИСЛО(31,10)) КАК СвободныйКоэффициентПостатейныеПостоянныеУпр,
	|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.ПостатейныеПеременныеУпр) 	 КАК ЧИСЛО(31,10)) КАК СвободныйКоэффициентПостатейныеПеременныеУпр,
	|
	...
	|			ИНАЧЕ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.Стоимость, 0) КАК ЧИСЛО(31,10))
	|				* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10))
	|			КОНЕЦ) КАК ЧИСЛО(31,10))
	|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(31,10)) КАК Стоимость,
	|	ВЫРАЗИТЬ(СУММА(
	|		ВЫБОР
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПередачаВЭксплуатацию, ЛОЖЬ) ТОГДА 0
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПостатейныеПостоянные, ЛОЖЬ) ТОГДА 0
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПостатейныеПеременные, ЛОЖЬ) ТОГДА 0
	|			ИНАЧЕ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьБезНДС, 0) КАК ЧИСЛО(31,10))
	|				* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10))
	|			КОНЕЦ) КАК ЧИСЛО(31,10))
	|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(31,10)) КАК СтоимостьБезНДС,
	|
	|	ВЫРАЗИТЬ(СУММА(
	|       (ВЫБОР
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
	...
	|				ТОГДА
	|					ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.Стоимость, 0) КАК ЧИСЛО(31,10))
	|					+ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьДопРасходы, 0) КАК ЧИСЛО(31,10))
	|					+ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.Трудозатраты, 0) КАК ЧИСЛО(31,10))
	|					+ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПостоянныеСНДС, 0) КАК ЧИСЛО(31,10))
	|					+ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПеременныеСНДС, 0) КАК ЧИСЛО(31,10))
	|			ИНАЧЕ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостояннаяРазница, 0) КАК ЧИСЛО(31,10))
	|				* ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостояннаяРазницаЗнак, 0) КАК ЧИСЛО(31,10))
	|			КОНЕЦ)
	|		* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10))) КАК ЧИСЛО(31,10))
	|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(31,10)) КАК ПостояннаяРазница,
	|	ВЫРАЗИТЬ(СУММА(
	|       (ВЫБОР
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПередачаВЭксплуатацию, ЛОЖЬ)
	|				ТОГДА ВЫРАЗИТЬ(ЕСТЬNULL(-ВтТаблицаРешений.Стоимость, 0) КАК ЧИСЛО(31,10))
	|					+ ВЫРАЗИТЬ(ЕСТЬNULL(-ВтТаблицаРешений.СтоимостьДопРасходы, 0) КАК ЧИСЛО(31,10))
	|			ИНАЧЕ 0 КОНЕЦ
	|       + ВЫБОР
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
	...
	|					+ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПостоянныеСНДС, 0) КАК ЧИСЛО(31,10))
	|					+ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПеременныеСНДС, 0) КАК ЧИСЛО(31,10))
	|					- ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостояннаяРазница, 0) КАК ЧИСЛО(31,10))
	|					* ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостояннаяРазницаЗнак, 0) КАК ЧИСЛО(31,10))
	|			ИНАЧЕ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ВременнаяРазница, 0) КАК ЧИСЛО(31,10))
	|				* ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ВременнаяРазницаЗнак, 0) КАК ЧИСЛО(31,10))
	|			КОНЕЦ)
	|		* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10))) КАК ЧИСЛО(31,10))
	|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(31,10)) КАК ВременнаяРазница,
	|
	|	ВЫРАЗИТЬ(СУММА(
	|       ВЫБОР
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПередачаВЭксплуатацию, ЛОЖЬ) ТОГДА 0
	|			ИНАЧЕ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьДопРасходы, 0) КАК ЧИСЛО(31,10))
	|				* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10))
	|			КОНЕЦ) КАК ЧИСЛО(31,10))
	|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(31,10)) КАК СтоимостьДопРасходы,
	|
	|	ВЫРАЗИТЬ(СУММА(
	|       ВЫБОР
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПередачаВЭксплуатацию, ЛОЖЬ) ТОГДА 0
	|			ИНАЧЕ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьДопРасходыБезНДС, 0) КАК ЧИСЛО(31,10))
	|				* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10))
	|			КОНЕЦ) КАК ЧИСЛО(31,10))
	|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(31,10)) КАК СтоимостьДопРасходыБезНДС,
	|
	|	ВЫРАЗИТЬ(СУММА(
	|		ВЫБОР
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.РаботаДляДавальца, ЛОЖЬ) ТОГДА 0
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПередачаВЭксплуатацию, ЛОЖЬ) ТОГДА 0
	|			ИНАЧЕ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьЗабалансовая, 0) КАК ЧИСЛО(31,10))
	|				* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10))
	|			КОНЕЦ) КАК ЧИСЛО(31,10))
	|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(31,10)) КАК СтоимостьЗабалансовая,
	|	ВЫРАЗИТЬ(СУММА(
	|		ВЫБОР
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПередачаВЭксплуатацию, ЛОЖЬ) ТОГДА 0
	...
	|			* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10))
	|		КОНЕЦ) КАК ЧИСЛО(31,10))
	|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(31,10)) КАК ПостатейныеПостоянныеСНДС,
	|
	|	ВЫРАЗИТЬ(СУММА(
	|       ВЫБОР
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПередачаВЭксплуатацию, ЛОЖЬ) ТОГДА 0
	|			ИНАЧЕ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.Трудозатраты, 0) КАК ЧИСЛО(31,10))
	|				* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10))
	|			КОНЕЦ) КАК ЧИСЛО(31,10))
	|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(31,10)) КАК Трудозатраты,
	|
	|	ВЫРАЗИТЬ(СУММА(
	|		ВЫБОР
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
	...
	|			(ВЫБОР
	|				КОГДА ЕСТЬNULL(ПеремещенияСписания.ПостатейныеПостоянные, ЛОЖЬ)
	|					ТОГДА ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьБезНДС, 0) КАК ЧИСЛО(31,10))
	|				ИНАЧЕ 0 КОНЕЦ
	|			+ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПостоянныеБезНДС, 0) КАК ЧИСЛО(31,10)))
	|			* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10))
	|		КОНЕЦ) КАК ЧИСЛО(31,10))
	|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(31,10)) КАК ПостатейныеПостоянныеБезНДС,
	|	ВЫРАЗИТЬ(СУММА(
	|		ВЫБОР
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПередачаВЭксплуатацию, ЛОЖЬ) ТОГДА 0
	...
	|			* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10))
	|		КОНЕЦ) КАК ЧИСЛО(31,10))
	|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(31,10)) КАК ПостатейныеПеременныеСНДС,
	|	ВЫРАЗИТЬ(СУММА(
	|		ВЫБОР
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПередачаВЭксплуатацию, ЛОЖЬ) ТОГДА 0
	...
	|					ТОГДА ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьБезНДС, 0) КАК ЧИСЛО(31,10))
	|				ИНАЧЕ 0 КОНЕЦ
	|			+ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПеременныеБезНДС, 0) КАК ЧИСЛО(31,10)))
	|			* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10))
	|		КОНЕЦ) КАК ЧИСЛО(31,10))
	|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(31,10)) КАК ПостатейныеПеременныеБезНДС,
	|
	|	ВЫРАЗИТЬ(СУММА(
	|		ВЫБОР
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
	...
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПостатейныеПостоянныеУпр, ЛОЖЬ) ТОГДА 0
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПостатейныеПеременныеУпр, ЛОЖЬ) ТОГДА 0
	|			ИНАЧЕ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьУпр, 0) КАК ЧИСЛО(31,10))
	|				* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10))
	|			КОНЕЦ) КАК ЧИСЛО(31,10))
	|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(31,10)) КАК СтоимостьУпр,
	|	ВЫРАЗИТЬ(СУММА(
	|       ВЫБОР
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПередачаВЭксплуатацию, ЛОЖЬ) ТОГДА 0
	|			ИНАЧЕ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ДопРасходыУпр, 0) КАК ЧИСЛО(31,10))
	|				* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10))
	|			КОНЕЦ) КАК ЧИСЛО(31,10))
	|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(31,10)) КАК ДопРасходыУпр,
	|	ВЫРАЗИТЬ(СУММА(
	|       ВЫБОР
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПередачаВЭксплуатацию, ЛОЖЬ) ТОГДА 0
	|			ИНАЧЕ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ТрудозатратыУпр, 0) КАК ЧИСЛО(31,10))
	|				* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10))
	|			КОНЕЦ) КАК ЧИСЛО(31,10))
	|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(31,10)) КАК ТрудозатратыУпр,
	|	ВЫРАЗИТЬ(СУММА(
	|		ВЫБОР
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПередачаВЭксплуатацию, ЛОЖЬ) ТОГДА 0
	...
	|					ТОГДА ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьУпр, 0) КАК ЧИСЛО(31,10))
	|				ИНАЧЕ 0 КОНЕЦ
	|			+ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПостоянныеУпр, 0) КАК ЧИСЛО(31,10)))
	|			* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10))
	|		КОНЕЦ) КАК ЧИСЛО(31,10))
	|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(31,10)) КАК ПостатейныеПостоянныеУпр,
	|	ВЫРАЗИТЬ(СУММА(
	|		ВЫБОР
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
	|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПередачаВЭксплуатацию, ЛОЖЬ) ТОГДА 0
	...
	|					ТОГДА ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьУпр, 0) КАК ЧИСЛО(31,10))
	|				ИНАЧЕ 0 КОНЕЦ
	|			+ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПеременныеУпр, 0) КАК ЧИСЛО(31,10)))
	|			* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10))
	|		КОНЕЦ) КАК ЧИСЛО(31,10))
	|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(31,10)) КАК ПостатейныеПеременныеУпр
	|
	...
	|		ИЛИ
	|		(ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.Стоимость, 0) КАК ЧИСЛО(31,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
	|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьЗабалансовая, 0) КАК ЧИСЛО(31,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
	|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьБезНДС, 0) КАК ЧИСЛО(31,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
	|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостояннаяРазница, 0) КАК ЧИСЛО(31,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
	|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ВременнаяРазница, 0) КАК ЧИСЛО(31,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
	|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьДопРасходы, 0) КАК ЧИСЛО(31,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
	|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьДопРасходыБезНДС, 0) КАК ЧИСЛО(31,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
	|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПостоянныеСНДС, 0) КАК ЧИСЛО(31,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
	|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПостоянныеБезНДС, 0) КАК ЧИСЛО(31,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
	|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПеременныеСНДС, 0) КАК ЧИСЛО(31,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
	|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПеременныеБезНДС, 0) КАК ЧИСЛО(31,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
	|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.Трудозатраты, 0) КАК ЧИСЛО(31,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
	|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьУпр, 0) КАК ЧИСЛО(31,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
	|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ДопРасходыУпр, 0) КАК ЧИСЛО(31,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
	|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ТрудозатратыУпр, 0) КАК ЧИСЛО(31,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
	|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПостоянныеУпр, 0) КАК ЧИСЛО(31,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
	|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПеременныеУпр, 0) КАК ЧИСЛО(31,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(31,10)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля))
	|
	|СГРУППИРОВАТЬ ПО
	...
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.ПостатейныеПостоянныеСНДС,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПостоянныеСНДС
	|			 + ВременнаяТаблицаРешений.ПостатейныеПостоянныеСНДС)) > 0 ТОГДА
	|
	|					ЕСТЬNULL(ТаблицаРешений.ПостатейныеПостоянныеСНДС,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПостоянныеСНДС
	|				 		+ ВременнаяТаблицаРешений.ПостатейныеПостоянныеСНДС)
	|			ИНАЧЕ
	|				-(
	|					ЕСТЬNULL(ТаблицаРешений.ПостатейныеПостоянныеСНДС,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПостоянныеСНДС
	|						+ ВременнаяТаблицаРешений.ПостатейныеПостоянныеСНДС)
	...
	|			КОНЕЦ
	|			)
	|		,0) КАК ОтклонениеПостатейныеПостоянныеСНДС,
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.ПостатейныеПостоянныеБезНДС,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПостоянныеБезНДС
	|			 + ВременнаяТаблицаРешений.ПостатейныеПостоянныеБезНДС)) > 0 ТОГДА
	|
	|					ЕСТЬNULL(ТаблицаРешений.ПостатейныеПостоянныеБезНДС,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПостоянныеБезНДС
	|				 		+ ВременнаяТаблицаРешений.ПостатейныеПостоянныеБезНДС)
	|			ИНАЧЕ
	|				-(
	|					ЕСТЬNULL(ТаблицаРешений.ПостатейныеПостоянныеБезНДС,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПостоянныеБезНДС
	|						+ ВременнаяТаблицаРешений.ПостатейныеПостоянныеБезНДС)
	...
	|			КОНЕЦ
	|			)
	|		,0) КАК ОтклонениеПостатейныеПостоянныеБезНДС,
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.ПостатейныеПеременныеСНДС,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПеременныеСНДС
	|			 + ВременнаяТаблицаРешений.ПостатейныеПеременныеСНДС)) > 0 ТОГДА
	|
	|					ЕСТЬNULL(ТаблицаРешений.ПостатейныеПеременныеСНДС,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПеременныеСНДС
	|				 		+ ВременнаяТаблицаРешений.ПостатейныеПеременныеСНДС)
	|			ИНАЧЕ
	|				-(
	|					ЕСТЬNULL(ТаблицаРешений.ПостатейныеПеременныеСНДС,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПеременныеСНДС
	|						+ ВременнаяТаблицаРешений.ПостатейныеПеременныеСНДС)
	...
	|			КОНЕЦ
	|			)
	|		,0) КАК ОтклонениеПостатейныеПеременныеСНДС,
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.ПостатейныеПеременныеБезНДС,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПеременныеБезНДС
	|			 + ВременнаяТаблицаРешений.ПостатейныеПеременныеБезНДС)) > 0 ТОГДА
	|
	|					ЕСТЬNULL(ТаблицаРешений.ПостатейныеПеременныеБезНДС,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПеременныеБезНДС
	|				 		+ ВременнаяТаблицаРешений.ПостатейныеПеременныеБезНДС)
	|			ИНАЧЕ
	|				-(
	|					ЕСТЬNULL(ТаблицаРешений.ПостатейныеПеременныеБезНДС,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПеременныеБезНДС
	|						+ ВременнаяТаблицаРешений.ПостатейныеПеременныеБезНДС)
	...
	|			КОНЕЦ
	|			)
	|		,0) КАК ОтклонениеПостатейныеПеременныеБезНДС,
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.СтоимостьУпр,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентУпр
	|			 + ВременнаяТаблицаРешений.СтоимостьУпр)) > 0 ТОГДА
	|
	|					ЕСТЬNULL(ТаблицаРешений.СтоимостьУпр,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентУпр
	|				 		+ ВременнаяТаблицаРешений.СтоимостьУпр)
	|			ИНАЧЕ
	|				-(
	|					ЕСТЬNULL(ТаблицаРешений.СтоимостьУпр,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентУпр
	|						+ ВременнаяТаблицаРешений.СтоимостьУпр)
	...
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.ДопРасходыУпр,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентДопРасходыУпр
	|			 + ВременнаяТаблицаРешений.ДопРасходыУпр)) > 0 ТОГДА
	|
	|					ЕСТЬNULL(ТаблицаРешений.ДопРасходыУпр,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентДопРасходыУпр
	|				 		+ ВременнаяТаблицаРешений.ДопРасходыУпр)
	|			ИНАЧЕ
	|				-(
	|					ЕСТЬNULL(ТаблицаРешений.ДопРасходыУпр,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентДопРасходыУпр
	|						+ ВременнаяТаблицаРешений.ДопРасходыУпр)
	...
	|			КОНЕЦ
	|			)
	|		,0) КАК ОтклонениеДопРасходыУпр,
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.ТрудозатратыУпр,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентТрудозатратыУпр
	|			 + ВременнаяТаблицаРешений.ТрудозатратыУпр)) > 0 ТОГДА
	|
	|					ЕСТЬNULL(ТаблицаРешений.ТрудозатратыУпр,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентТрудозатратыУпр
	|				 		+ ВременнаяТаблицаРешений.ТрудозатратыУпр)
	|			ИНАЧЕ
	|				-(
	|					ЕСТЬNULL(ТаблицаРешений.ТрудозатратыУпр,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентТрудозатратыУпр
	|						+ ВременнаяТаблицаРешений.ТрудозатратыУпр)
	...
	|			КОНЕЦ
	|			)
	|		,0) КАК ОтклонениеТрудозатратыУпр,
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.ПостатейныеПостоянныеУпр,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПостоянныеУпр
	|			 + ВременнаяТаблицаРешений.ПостатейныеПостоянныеУпр)) > 0 ТОГДА
	|
	|					ЕСТЬNULL(ТаблицаРешений.ПостатейныеПостоянныеУпр,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПостоянныеУпр
	|				 		+ ВременнаяТаблицаРешений.ПостатейныеПостоянныеУпр)
	|			ИНАЧЕ
	|				-(
	|					ЕСТЬNULL(ТаблицаРешений.ПостатейныеПостоянныеУпр,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПостоянныеУпр
	|						+ ВременнаяТаблицаРешений.ПостатейныеПостоянныеУпр)
	...
	|			КОНЕЦ
	|			)
	|		,0) КАК ОтклонениеПостатейныеПостоянныеУпр,
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.ПостатейныеПеременныеУпр,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПеременныеУпр
	|			 + ВременнаяТаблицаРешений.ПостатейныеПеременныеУпр)) > 0 ТОГДА
	|
	|					ЕСТЬNULL(ТаблицаРешений.ПостатейныеПеременныеУпр,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПеременныеУпр
	|				 		+ ВременнаяТаблицаРешений.ПостатейныеПеременныеУпр)
	|			ИНАЧЕ
	|				-(
	|					ЕСТЬNULL(ТаблицаРешений.ПостатейныеПеременныеУпр,0) - (ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПеременныеУпр
	|						+ ВременнаяТаблицаРешений.ПостатейныеПеременныеУпр)
	...
	|			КОНЕЦ
	|			)
	|		,0) КАК ОтклонениеПостатейныеПеременныеУпр
	|ИЗ
	...
	|			+ ВременнаяТаблицаРешений.Стоимость
	|		КАК ЧИСЛО(31,10))              КАК Стоимость,
	|	ВЫРАЗИТЬ(
	|		ВременнаяТаблицаРешений.СвободныйКоэффициентБезНДС
	|			+ ВременнаяТаблицаРешений.СтоимостьБезНДС
	|		КАК ЧИСЛО(31,10))              КАК СтоимостьБезНДС,
	|	ВЫРАЗИТЬ(ВЫБОР
	|	 	КОГДА ВременнаяТаблицаРешений.СвободныйКоэффициентВременнаяРазница * ВременнаяТаблицаРешений.ВременнаяРазницаЗнак + ВременнаяТаблицаРешений.ВременнаяРазница < 0
	...
	|			+ ВременнаяТаблицаРешений.СтоимостьДопРасходы 
	|		КАК ЧИСЛО(31,10))              КАК СтоимостьДопРасходы,
	|	ВЫРАЗИТЬ(
	|		ВременнаяТаблицаРешений.СвободныйКоэффициентДопРасходыБезНДС
	|			+ ВременнаяТаблицаРешений.СтоимостьДопРасходыБезНДС 
	|		КАК ЧИСЛО(31,10))              КАК СтоимостьДопРасходыБезНДС,
	|
	|	ВЫРАЗИТЬ(
	|		ВременнаяТаблицаРешений.СвободныйКоэффициентСтоимостьЗабалансовая
	|			+ ВременнаяТаблицаРешений.СтоимостьЗабалансовая
	|		КАК ЧИСЛО(31,10))              КАК СтоимостьЗабалансовая,
	|	ВЫРАЗИТЬ(
	|		ВременнаяТаблицаРешений.СвободныйКоэффициентТрудозатраты
	|			+ ВременнаяТаблицаРешений.Трудозатраты
	|		КАК ЧИСЛО(31,10))              КАК Трудозатраты,
	|	ВЫРАЗИТЬ(
	|		ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПостоянныеСНДС
	|			+ ВременнаяТаблицаРешений.ПостатейныеПостоянныеСНДС
	|		КАК ЧИСЛО(31,10))              КАК ПостатейныеПостоянныеСНДС,
	|	ВЫРАЗИТЬ(
	|		ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПостоянныеБезНДС
	|			+ ВременнаяТаблицаРешений.ПостатейныеПостоянныеБезНДС
	|		КАК ЧИСЛО(31,10))              КАК ПостатейныеПостоянныеБезНДС,
	|	ВЫРАЗИТЬ(
	|		ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПеременныеСНДС
	|			+ ВременнаяТаблицаРешений.ПостатейныеПеременныеСНДС
	|		КАК ЧИСЛО(31,10))              КАК ПостатейныеПеременныеСНДС,
	|	ВЫРАЗИТЬ(
	|		ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПеременныеБезНДС
	|			+ ВременнаяТаблицаРешений.ПостатейныеПеременныеБезНДС
	|		КАК ЧИСЛО(31,10))              КАК ПостатейныеПеременныеБезНДС,
	|	ВЫРАЗИТЬ(
	|		ВременнаяТаблицаРешений.СвободныйКоэффициентУпр
	|			+ ВременнаяТаблицаРешений.СтоимостьУпр
	|		КАК ЧИСЛО(31,10))              КАК СтоимостьУпр,
	|	ВЫРАЗИТЬ(
	|		ВременнаяТаблицаРешений.СвободныйКоэффициентДопРасходыУпр
	|			+ ВременнаяТаблицаРешений.ДопРасходыУпр
	|		КАК ЧИСЛО(31,10))              КАК ДопРасходыУпр,
	|	ВЫРАЗИТЬ(
	|		ВременнаяТаблицаРешений.СвободныйКоэффициентТрудозатратыУпр
	|			+ ВременнаяТаблицаРешений.ТрудозатратыУпр
	|		КАК ЧИСЛО(31,10))              КАК ТрудозатратыУпр,
	|	ВЫРАЗИТЬ(
	|		ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПостоянныеУпр
	|			+ ВременнаяТаблицаРешений.ПостатейныеПостоянныеУпр
	|		КАК ЧИСЛО(31,10))              КАК ПостатейныеПостоянныеУпр,
	|	ВЫРАЗИТЬ(
	|		ВременнаяТаблицаРешений.СвободныйКоэффициентПостатейныеПеременныеУпр
	|			+ ВременнаяТаблицаРешений.ПостатейныеПеременныеУпр
	|		КАК ЧИСЛО(31,10))              КАК ПостатейныеПеременныеУпр
	|
	|ПОМЕСТИТЬ ВтТаблицаРешений
	|
	|ИЗ
	...
	|	ИЛИ	(ВременнаяТаблицаРешений.СвободныйКоэффициент + ВременнаяТаблицаРешений.Стоимость) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	НомерУзла
	|;
...
Процедура СохранитьДанныеСЛУ(ПараметрыРасчета, РасчетСтоимостиРегл)
	...
	ИмяКаталога = СокрЛП(ПараметрыРасчета.Отладка.КаталогДляСохраненияДанныхСЛУ);
	...
	ФорматВыгрузки = СокрЛП(НРег(ПараметрыРасчета.Отладка.ФорматСохраненияДанныхСЛУ));
	...
	ИначеЕсли ФорматВыгрузки = "csv" Тогда
		...
		|	ВЫРАЗИТЬ(ЕСТЬNULL(Коэффициенты.Количество, 0) КАК ЧИСЛО(31,10)) КАК КоэффициентНеизвестного,
		|	ВЫРАЗИТЬ(ВЫБОР
		...
		|		КОНЕЦ КАК ЧИСЛО(31,10)) КАК СвободныйКоэффициент
		|ИЗ
