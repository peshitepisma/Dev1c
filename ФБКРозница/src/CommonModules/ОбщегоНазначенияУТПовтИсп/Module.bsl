...
Функция КонстантыДоступныеВБазовойВерсии() Экспорт 
	...
	Результат.Вставить(Метаданные.Константы.ОперацииСТоварамиОблагаемымиНДСУПокупателя.Имя);
...
Функция СоответствиеКодовОКВЭД() Экспорт
	...
	Возврат Справочники.Организации.СоотвествиеКодовКНаименованиюИзМакета("ОКВЭД"); 
