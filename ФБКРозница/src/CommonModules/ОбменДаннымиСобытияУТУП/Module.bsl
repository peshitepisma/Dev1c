...
Процедура ОбменДаннымиОбменУправлениеТорговлейУправлениеТорговлейПередЗаписьюДокумента(Источник, Отказ, РежимЗаписи, РежимПроведения) Экспорт
	
	ОбменДаннымиСобытия.МеханизмРегистрацииОбъектовПередЗаписьюДокумента("ОбменУправлениеТорговлейУправлениеТорговлей", Источник, Отказ, РежимЗаписи, РежимПроведения);	// Вставить содержимое обработчика.
