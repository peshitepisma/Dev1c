...
Функция ТекстЗапросаРаспоряженияНаДоставкуПолучателямПоОрдернойСхеме(ВыборочноеОбновление)
	...
	|		РаспоряженияНаДоставку.Зона                  КАК Зона,
	|		РаспоряженияНаДоставку.Перевозчик            КАК Перевозчик,
	|		ТоварыСУчетомДоставленных.КОтгрузке КАК Количество,      // Количество
	|		ТоварыСУчетомДоставленных.КОтгрузке * &ТекстЗапросаВесУпаковки КАК Вес,
	|		ТоварыСУчетомДоставленных.КОтгрузке * &ТекстЗапросаОбъемУпаковки КАК Объем,
	...
	|		ТоварыСУчетомДоставленных.КОтгрузке,
	|		ТоварыСУчетомДоставленных.КОтгрузке * &ТекстЗапросаВесУпаковки,
	|		ТоварыСУчетомДоставленных.КОтгрузке * &ТекстЗапросаОбъемУпаковки
	|	
	|	ОБЪЕДИНИТЬ ВСЕ
	|	
	|	ВЫБРАТЬ
