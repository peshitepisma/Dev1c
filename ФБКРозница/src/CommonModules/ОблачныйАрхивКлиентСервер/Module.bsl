...
#Область ЗапускПриложения
	...
	ИнтернетПоддержкаПользователейКлиентСервер.НачатьРегистрациюРезультатаВыполненияОперации(
		КонтекстВыполнения,
		"ОблачныйАрхивКлиентСервер.ВыполнитьСтрокуКоманды/Запуск командного файла", // Идентификатор.
...
#КонецОбласти
	...
	ИнтернетПоддержкаПользователейКлиентСервер.ЗарегистрироватьРезультатВыполненияОперации(
		КонтекстВыполнения,
		"ОблачныйАрхивКлиентСервер.ВыполнитьСтрокуКоманды/Запуск в веб-клиенте", // Идентификатор.
