...
Процедура ЗаполнитьКоличествоЧековПродаж(ТаблицаПродаж) Экспорт
	...
	|		ПО ТаблицаПродаж.АлкогольнаяПродукция = СоответствиеНоменклатурыЕГАИС.АлкогольнаяПродукция
	|ГДЕ
	...
	|			И ЧекККМТовары.Номенклатура = ТаблицаПродаж.Номенклатура
	|			И ЧекККМТовары.Характеристика = ТаблицаПродаж.Характеристика
	...
	|			И ЧекККМВозвратТовары.Номенклатура = ТаблицаПродаж.Номенклатура
	|			И ЧекККМВозвратТовары.Характеристика = ТаблицаПродаж.Характеристика
