...
//
Функция ОбновитьСтатус(Документ, ПараметрыОбновления, ОбновлятьДвижения = Истина) Экспорт
	...
	Если ЗаписатьНабор Тогда
		...
		ИнтеграцияЕГАИС.ПриИзмененииСтатусаДокумента(
			Документ,
			СтарыйСтатус, НовыйСтатус, ОбновлятьДвижения);
...
Функция ВозвращаемоеЗначениеДальнейшиеДействияСтатус(Статус, ДальнейшиеДействия, ОчиститьПрочее = Истина, Прочее = Неопределено)
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			ВерсияДанных = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ДокументСсылка, "ВерсияДанных");
